...
export const FONTES_SAUDE = [
  ...
  // Paradigma WBC — portais de compras do SEST/SENAT e da Firjan (POST)
  ...[
    { id: "paradigma-sest", nome: "SEST/SENAT (compras.sestsenat.org.br)", host: "https://compras.sestsenat.org.br" },
    { id: "paradigma-firjan", nome: "SESI/SENAI-RJ (portaldecompras.firjan.com.br)", host: "https://portaldecompras.firjan.com.br" },
    { id: "paradigma-fiemg", nome: "SESI/SENAI-MG (FIEMG)", host: "https://compras.fiemg.com.br" },
    { id: "paradigma-sescsp", nome: "SESC-SP (scr360)", host: "https://scr360.paradigmabs.com.br/sescsp" },
  ].map((p) => ({
    id: p.id,
    nome: p.nome,
    tipo: "paradigma",
    url: `${p.host}/portal/WebService/Servicos.asmx/PesquisarProcessos`,
    metodo: "POST",
